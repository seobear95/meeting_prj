...
public class MeetingDAO {
    ...
    public static void insertMeeting(Connection con, String t,
        ...
        try {
            ...
            pst.setString(3, l);
            int rows = pst.executeUpdate();   // insert, delete , update sql
    ...
    public static void selectMeeting(Connection con, int meeting_id)
    {
        ...
        try{
           PreparedStatement pst = con.prepareStatement(sql);
           pst.setInt(1, meeting_id);
           ResultSet rs = pst.executeQuery();  // 1 row or 0 row
           if(rs.next()){
               int id = rs.getInt("id");
    ...
    public static void selectAllMeeting(Connection con)
    {
        ...
        try{
            PreparedStatement pst = con.prepareStatement(sql);
            ResultSet rs = pst.executeQuery();  // pst.executeQuery() vs pst.executeUpdate()
